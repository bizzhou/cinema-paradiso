...
def process_film(celeb, data, link, img, is_tv):
    celeb_dict = {}
    link_dict = {}
    image_dict = {}
    ...
    for line in data:
        ...
        movie_json['criticRating'] = round(
            (movie_json['regUserRating'] - float(random.randrange(6)) / 10 + float(random.randrange(4)) / 10), 1)
...
celeb1 = json.load(open('./recent_movies/recent_celeb.json', encoding='utf8'))
data1 = open('./recent_movies/recent_data.txt', encoding='utf8')
link1 = open('./recent_movies/recent_movie_celeb_id_link.json', encoding='utf8')
images1 = json.load(open('./recent_movies/recent_images.json', encoding='utf8'))

celeb2 = json.load(open('./tv/tv_celeb.json', encoding='utf8'))
data2 = open('./tv/tv_data.txt', encoding='utf8')
link2 = open('./tv/tv_celeb_id_link.json', encoding='utf8')
